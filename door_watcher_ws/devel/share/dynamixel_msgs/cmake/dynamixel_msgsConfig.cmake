...
if(NOT "/home/student/door-watcher/door_watcher_ws/devel/include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'dynamixel_msgs' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/student/door-watcher/door_watcher_ws/src/dynamixel_motor-master/dynamixel_msgs/${idir}'.  ${_report}")
    endif()
